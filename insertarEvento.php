...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
		$ruta= "The file ". htmlspecialchars( basename( $_FILES["fileToUpload"]["name"]))." has been uploaded.";
...
if($nombreEvento AND $fechaInicio AND $fechaFinal AND $horaInicio AND $horaFinal AND $lugar AND $tipo AND $banner){
    	$validate = true;
	...
	if( $validate == true)
	{
 $SQL = "INSERT INTO eventos(nombreEvento,fechaInicio,fechaFinal,horaInicio,horaFinal,lugar,status,tipo,banner) VALUES ('$nombreEvento','$fechaInicio','$fechaFinal','$horaInicio','$horaFinal','$lugar','Proximo','$tipo','$banner')";
	consultar($con, $SQL);
    	}
	else
	{
